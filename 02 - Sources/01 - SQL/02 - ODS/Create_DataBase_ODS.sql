/*
*Author; IZI
*Type : Création de la base de données ODS 
*Base : ODS
*Date : 01/09/2017
*Version : v0.01
...
CREATE DATABASE [ODS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ODS', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.INST_SQL01\MSSQL\DATA\ODS.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ODS_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.INST_SQL01\MSSQL\DATA\ODS_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [ODS] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [ODS] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
